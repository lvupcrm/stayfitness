        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <Link href="/programs" className="group">
              <div className="p-6 bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-200 border hover:border-gray-300">
                ...
                <div className="flex items-center text-gray-700 group-hover:translate-x-1 transition-transform">
            ...
            <div className="md:col-span-2 lg:col-span-1">
              <div className="p-6 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl text-white h-full flex flex-col justify-center">
                ...
                <Button 
                  asChild 
                  variant="secondary" 
                  className="bg-white text-gray-900 hover:bg-gray-50 w-fit"
                >
